...
# https://seattle.bibliocommons.com/v2/search?query=Beastly+Babies&searchType=smart
# https://seattle.bibliocommons.com/item/show/1277240030
...
import xlwt
import xlrd
url="https://seattle.bibliocommons.com/v2/search?query={}&searchType=smart"
colum=["cudosid","goodreadsid","title","author","goodreadsUrl","aclibraryUrl","detailUrl"]
file=xlwt.Workbook(encoding='utf-8',style_compression=0)
sheet=file.add_sheet("Seattle",cell_overwrite_ok=True)
for i in colum:
...
with open('cudos_goodreads.txt', "r") as f:
    ...
    for data in datas:
        ...
        if link:
            detailUrl = "https://seattle.bibliocommons.com" + link
        else:
            detailUrl = "None"
